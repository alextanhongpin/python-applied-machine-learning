...
|  | count | unique | top | freq |
| Sentiment |  |  |  |  |
| 0 | 24697 | 24697 | Once again Mr. Costner has dragged out a movie... | 1 |
| 1 | 24884 | 24884 | I went and saw this movie last night after bei... | 1 |
...
![](02_sentiment_analysis_files/figure-commonmark/cell-9-output-1.png)

``` python
text = 'The long lines and poor customer service really turned me off'
model.predict_proba(vectorizer.transform([text]))[0][1] # probablity positive
```

    np.float64(0.15697058537756034)
